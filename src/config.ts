...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: 'assets/images/fengmian.png',   // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    position: 'center',      // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
    credit: {
      enable: true,         // Display the credit text of the banner image
      text: '他身在高楼广厦之中，却有山泽鱼鸟之思',              // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/sereinna',     // Internal links should not include the base path, as it is automatically added
